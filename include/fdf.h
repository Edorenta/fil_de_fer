...
# define SWITCH_HORI	(env->view.view_mode ^= (1 << 0))
# define SWITCH_VERTI	(env->view.view_mode ^= (1 << 1))
# define SWITCH_DIAG1	(env->view.view_mode ^= (1 << 2))
# define SWITCH_DIAG2	(env->view.view_mode ^= (1 << 3))
# define IS_SET_HORI	(env->view.view_mode & (1 << 0))
# define IS_SET_VERTI	(env->view.view_mode & (1 << 1))
# define IS_SET_DIAG1	(env->view.view_mode & (1 << 2))
# define IS_SET_DIAG2	(env->view.view_mode & (1 << 3))
...
# define Y_MIN			(env->grid.min_y)
# define Y_MAX			(env->grid.max_y)
# define X_MIN			(env->grid.min_x)
# define X_MAX			(env->grid.max_x)
# define X_MED			((X_MAX + X_MIN) / 2)
# define X_OFFSET		(env->grid.x_offset)
# define Y_OFFSET		(env->grid.y_offset)
# define MAX_PERSP		99
# define PERSP			((double)(env->view.persp_coef / (double)MAX_PERSP))
# define PERSP_X		((double)(rx[i]) / (double)(X_MAX - MID_X)))
# define PERSP_Y		((double)(pt[i].y - Y_MIN) / (double)(Y_MAX - Y_MIN))
# define BUFF_SIZE		100
# define P_ISOMETRIC	0
